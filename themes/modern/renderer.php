	...
	class renderer
	{
		...
		function menu_header($title, $no_menu, $is_index)
		{
			...
			if (!$no_menu)
			{
			 ...
			 // 	if ($help_base_url != null)
				...
				// echo "<img src='$local_path_to_root/themes/modern/images/product.gif' alt='"._('ItLink Corporation')."'>";
				// echo "</ul>\n";
					echo "<table width='100%' valign='center'>
							...
							<tr>
							    <td></td>
							    <td></td> 
							    <td><img src='$local_path_to_root/themes/modern/images/header_img.png' height='100px' alt='"._('ItLink Corporation')."'></td>
							    <td></td>
							    <td width='40%'></td> 
							    <td></td>
							    <td></td>
							    <td><img src='$local_path_to_root/themes/modern/images/fc.png'  height='80px'  alt='"._('Front Accounting')."'> </td> 

							    <td width='70%'>
							    <td><td><img src='$local_path_to_root/themes/modern/images/customer.png' height='100px'  alt='"._('Dartex')."'></td></td>
							    <td></td> 
			   ...
			   // echo "<div id='menu2'>\n";
				...
				echo "<table width='100%' valign='center'>
							...
							<tr>
							    ...
							    <td></td> 
							    <td> 
							     <img src='$local_path_to_root/themes/modern/images/lock.gif' width='14' height='14' border='0' alt='"._('Change password')."'>
							    <a class='shortcut' href='$path_to_root/admin/change_current_user_password.php?selected_id=" . $_SESSION["wa_current_user"]->username . "'>" . _("Change password") . "</a> | 
							      <img src='$local_path_to_root/themes/modern/images/login.gif' width='14' height='14' border='0' alt='"._('Logout')."'><a class='shortcut' href='$path_to_root/access/logout.php?'>$img" . _("Logout") . "</a> 
							     </td>
							</tr>
				     </table>";
		...
		function menu_footer($no_menu, $is_index)
		{
			...
			if ($no_menu == false)
			{
				...
				{
					echo "<span class='power'><a>$power_by $version</a></span>\n";
		...
		function display_applications(&$waapp)
		{
			...
			foreach ($sel_app->modules as $module)
			{
				...
				echo "<table class='table' width='85%' align='center'><tr>";
