...
class assets_app extends application
{
	function assets_app()
	{
		...
		$this->add_lapp_function(0, _("Fixed Assets Purchase"),
			"purchasing/po_entry_items.php?NewInvoice=YesFixedAsset=1", 'SA_SUPPLIERINVOICE', MENU_TRANSACTION);
		$this->add_lapp_function(0, _("Fixed Assets Location Transfers"),
			"inventory/transfers.php?NewTransfer=1FixedAsset=1", 'SA_ASSETTRANSFER', MENU_TRANSACTION);
		$this->add_lapp_function(0, _("Fixed Assets Disposal"),
			"inventory/adjustments.php?NewAdjustment=1FixedAsset=1", 'SA_ASSETDISPOSAL', MENU_TRANSACTION);
		$this->add_lapp_function(0, _("Fixed Assets Sale"),
			"sales/sales_order_entry.php?NewInvoice=0FixedAsset=1", 'SA_SALESINVOICE', MENU_TRANSACTION);
	...
	//		"inventory/cost_update.php?FixedAsset=1", 'SA_STANDARDCOST', MENU_MAINTENANCE);
		...
		$this->add_rapp_function(2, _("Fixed Assets Classes"),
