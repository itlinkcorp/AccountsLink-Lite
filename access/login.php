...
function defaultCompany()
{
	...
	echo "<center><a target='_blank'><img src='$path_to_root/themes/$def_theme/images/login_page_logo.png' alt='FrontAccounting' height='100'  width='33%' onload='fixPNG(this)' border='0' ></a></center>";
	...
	if (!$login_timeout) { // FA logo
    	echo "<a target='_blank'><img src='$path_to_root/themes/$def_theme/images/logo_frontaccounting1.png' alt='FrontAccounting' height='50' width='100%'  onload='fixPNG(this)' border='0' ></a>";
	} else { 
